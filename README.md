...
Smart Refrigerator is a project I built to make managing a fridge smarter and easier. It keeps track of all your items, alerts you when things are close to expiry, and suggests groceries when stock is low. The project uses Python, FastAPI, and SQLite for a clean, scalable backend.
